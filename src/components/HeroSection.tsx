...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden text-primary-foreground" style={{ minHeight: 320 }}>
      {SLIDES.map((slide, i) => (
        <img
          key={i}
          src={slide.src}
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center justify-center px-6 py-10 text-center md:py-14">
        {/* Badge */}
